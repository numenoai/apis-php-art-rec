 ...
 *
 * @category Class
 * @description Information needed to update a feed.
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class FeedUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['persona_id']) && !preg_match("/^[a-zA-Z0-9-_:.]{1,256}$/", $this->container['persona_id'])) {
     ...
     * Sets persona_id
     *
     * @param string|null $persona_id The ID of the Persona used to generate the feed
     *
     * @return self
     */
    public function setPersonaId($persona_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_:.]{1,256}$/", ObjectSerializer::toString($persona_id)))) {
            throw new \InvalidArgumentException("invalid value for \$persona_id when calling FeedUpdate., must conform to the pattern /^[a-zA-Z0-9-_:.]{1,256}$/.");
        }
