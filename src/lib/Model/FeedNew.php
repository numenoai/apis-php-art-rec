...
/**
 * FeedNew Class Doc Comment
 *
 * @category Class
 * @description Information needed to create a feed.
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FeedNew implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedNew';
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling FeedNew., must be smaller than or equal to 256.');
        }
    ...
    public function setPersonaId($persona_id)
    {
        ...
        if ((!preg_match("/^[a-zA-Z0-9-_:.]{1,256}$/", ObjectSerializer::toString($persona_id)))) {
            throw new \InvalidArgumentException("invalid value for \$persona_id when calling FeedNew., must conform to the pattern /^[a-zA-Z0-9-_:.]{1,256}$/.");
        }
