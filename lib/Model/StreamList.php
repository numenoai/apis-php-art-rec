 ...
 */
class StreamList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'StreamList';
    ...
    protected static $openAPITypes = [
        'streams' => '\NumenoArtRec\Model\Stream[]',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets streams
     *
     * @return \NumenoArtRec\Model\Stream[]
     */
     ...
     * Sets streams
     *
     * @param \NumenoArtRec\Model\Stream[] $streams streams
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling StreamList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
