...
/**
 * SourceAndCountList Class Doc Comment
 *
 * @category Class
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 ...
 */
class SourceAndCountList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SourceAndCountList';
    ...
    protected static $openAPITypes = [
        'sources' => '\NumenoArtRec\Model\SourceAndCount[]',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets sources
     *
     * @return \NumenoArtRec\Model\SourceAndCount[]
     */
     ...
     * Sets sources
     *
     * @param \NumenoArtRec\Model\SourceAndCount[] $sources sources
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling SourceAndCountList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
