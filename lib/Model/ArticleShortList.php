...
/**
 * ArticleShortList Class Doc Comment
 *
 * @category Class
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 ...
 */
class ArticleShortList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleShortList';
    ...
    protected static $openAPITypes = [
        'articles' => '\NumenoArtRec\Model\ArticleShort[]',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets articles
     *
     * @return \NumenoArtRec\Model\ArticleShort[]
     */
     ...
     * Sets articles
     *
     * @param \NumenoArtRec\Model\ArticleShort[] $articles articles
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling ArticleShortList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
