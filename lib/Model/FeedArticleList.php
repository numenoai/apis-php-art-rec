...
/**
 * FeedArticleList Class Doc Comment
 *
 * @category Class
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 ...
 */
class FeedArticleList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedArticleList';
    ...
    protected static $openAPITypes = [
        'articles' => '\NumenoArtRec\Model\FeedArticle[]',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets articles
     *
     * @return \NumenoArtRec\Model\FeedArticle[]
     */
     ...
     * Sets articles
     *
     * @param \NumenoArtRec\Model\FeedArticle[] $articles articles
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling FeedArticleList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
