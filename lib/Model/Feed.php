    ...
    */
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling Feed., must be smaller than or equal to 256.');
        }
    ...
    public function setId($id)
    {
        ...
        if ((!preg_match("/^[a-f0-9]{32}$/", ObjectSerializer::toString($id)))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling Feed., must conform to the pattern /^[a-f0-9]{32}$/.");
        }
