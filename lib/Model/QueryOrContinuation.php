...
/**
 * QueryOrContinuation Class Doc Comment
 *
 * @category Class
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 ...
 */
class QueryOrContinuation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'QueryOrContinuation';
    ...
    protected static $openAPITypes = [
        'query' => '\NumenoArtRec\Model\Query',
        'limit' => 'int',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets query
     *
     * @return \NumenoArtRec\Model\Query
     */
     ...
     * Sets query
     *
     * @param \NumenoArtRec\Model\Query $query query
     *
     * @return self
     */
    ...
    public function setLimit($limit)
    {
        ...
        if (($limit > 20)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling QueryOrContinuation., must be smaller than or equal to 20.');
        }
        if (($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling QueryOrContinuation., must be bigger than or equal to 1.');
        }
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling QueryOrContinuation., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
