...
/**
 * TopicAndWeightList Class Doc Comment
 *
 * @category Class
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 ...
 */
class TopicAndWeightList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TopicAndWeightList';
    ...
    protected static $openAPITypes = [
        'topics' => '\NumenoArtRec\Model\TopicAndWeight[]',
        'cursor' => 'string'
    ];
    ...
    */
     ...
     * Gets topics
     *
     * @return \NumenoArtRec\Model\TopicAndWeight[]
     */
     ...
     * Sets topics
     *
     * @param \NumenoArtRec\Model\TopicAndWeight[] $topics A list of Topics and their weights observed in the requested date range.  This weight is a rough indication of how many documents are related to that Topic and how important this Topic was in these documents. For example, a weight of 1.0 could mean that one document was found with this Topic as the main one.
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling TopicAndWeightList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
