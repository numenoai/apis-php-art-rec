 ...
 */
class FeedList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FeedList';
    ...
    */
     ...
     * Gets feeds
     *
     * @return \NumenoArtRec\Model\Feed[]
     */
     ...
     * Sets feeds
     *
     * @param \NumenoArtRec\Model\Feed[] $feeds feeds
     *
     * @return self
     */
    ...
    public function setCursor($cursor)
    {
        ...
        if ((!preg_match("/^[\\x21-\\x7E]{0,1024}$/", ObjectSerializer::toString($cursor)))) {
            throw new \InvalidArgumentException("invalid value for \$cursor when calling FeedList., must conform to the pattern /^[\\x21-\\x7E]{0,1024}$/.");
        }
