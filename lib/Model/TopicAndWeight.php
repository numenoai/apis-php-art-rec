...
/**
 * TopicAndWeight Class Doc Comment
 *
 * @category Class
 * @description The canonical name of a Topic paired with its weight observed in the requested date range.
 * @package  NumenoArtRec
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TopicAndWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TopicAndWeight';
    ...
    */
    ...
    public function setTopic($topic)
    {
        ...
        if ((mb_strlen($topic) > 256)) {
            throw new \InvalidArgumentException('invalid length for $topic when calling TopicAndWeight., must be smaller than or equal to 256.');
        }
    ...
    public function setWeight($weight)
    {
        ...
        if (($weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $weight when calling TopicAndWeight., must be bigger than or equal to 0.');
        }
